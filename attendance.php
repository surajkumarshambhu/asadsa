	...
	if(isset($_POST['employee'])){
		...
		if($query->num_rows > 0){
			...
			if($status == 'in'){
				...
				if($query->num_rows > 0){
					$output['error'] = true;
					echo "<script type='text/javascript'>alert('Hi Dear You have timed in for today');</script>";
				...
				if($query->num_rows < 1){
					...
					if($row['time_out'] != '00:00:00'){
						$output['error'] = true;
						echo "<script type='text/javascript'>alert('Hii Dear You have timed out for today');</script>";
						echo "<meta http-equiv=\"refresh\" content=\"0;URL=index.php\">";
					}
					else{
